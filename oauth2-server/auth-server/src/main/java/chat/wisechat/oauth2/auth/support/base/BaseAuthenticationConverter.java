...
import chat.wisechat.oauth2.auth.utils.OAuth2EndpointUtils;
...
public abstract class BaseAuthenticationConverter implements AuthenticationConverter {
    ...
    public abstract Authentication buildAuthentication(Authentication clientPrincipal, Set<String> requestedScopes,
    ...
    public Authentication convert(HttpServletRequest request) {
        ...
        return buildAuthentication(clientPrincipal, requestedScopes, additionalParameters);
    }
}
